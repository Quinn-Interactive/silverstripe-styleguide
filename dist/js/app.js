...
var $lists = document.querySelectorAll('[data-nav-list]');
var $items = document.querySelectorAll('[data-nav-item]'); // add section classes

$lists.forEach(function ($list) {
  var $active = $list.querySelector('[data-nav-item].-active');
...
$items.forEach(function ($item) {
  var $sublist = $item.querySelector('[data-nav-list]');
