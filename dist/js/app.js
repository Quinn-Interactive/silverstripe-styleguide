...
__webpack_require__(/*! srcdoc-polyfill */ "./node_modules/srcdoc-polyfill/srcdoc-polyfill.js");

__webpack_require__(/*! ./components/html-js */ "./javascript/components/html-js.js");

__webpack_require__(/*! ./components/nav */ "./javascript/components/nav.js");

__webpack_require__(/*! ./components/clipboard-button */ "./javascript/components/clipboard-button.js");

__webpack_require__(/*! ./components/toggle */ "./javascript/components/toggle.js");

__webpack_require__(/*! ./components/resizer */ "./javascript/components/resizer.js");
...
/***/ "./javascript/components/html-js.js":
/*!******************************************!*\
  !*** ./javascript/components/html-js.js ***!
  \******************************************/
/*! no static exports found */
...
if (resize_observer_polyfill__WEBPACK_IMPORTED_MODULE_2__["default"]) {
  var $wrappers = document.querySelectorAll('[data-sg-iframe-wrapper]');
  $wrappers.forEach(function ($wrapper) {
    var $iframe = $wrapper.querySelector('[data-sg-iframe]');
    var ro = new resize_observer_polyfill__WEBPACK_IMPORTED_MODULE_2__["default"](lodash_debounce__WEBPACK_IMPORTED_MODULE_3___default()(function () {
      iframeResizer($iframe);
    }, 100));
    ro.observe($wrapper);
  });
...
/* harmony import */ var lodash_delay__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! lodash/delay */ "./node_modules/lodash/delay.js");
...
var $btn = document.querySelector('[data-sg-nav-btn]');
var $lists = document.querySelectorAll('[data-sg-nav-list]');
var $items = document.querySelectorAll('[data-sg-nav-item]');
var $searchableLists = document.querySelectorAll('[data-sg-nav-searchable] [data-sg-nav-list]');
var $searchableItems = document.querySelectorAll('[data-sg-nav-searchable] [data-sg-nav-item]');

var cqReevaluate = function cqReevaluate() {
  // reevaluate cq-prolyfill if we are using it
  // https://github.com/ausi/cq-prolyfill
  if (window.cqApi) {
    lodash_delay__WEBPACK_IMPORTED_MODULE_3___default()(function () {
...
$lists.forEach(function ($list) {
  var $active = $list.querySelector('[data-sg-nav-item].-active');
...
$items.forEach(function ($item) {
  var $sublist = $item.querySelector('[data-sg-nav-list]');
...
var $search = document.querySelector('[data-sg-nav-search]');

if ($search) {
  $search.addEventListener('input', function () {
    var val = $search.value.toLowerCase(); // if the val is empty, return to normal
    ...
    if (!val) {
      ...
      $searchableItems.forEach(function ($item) {
        ...
        var $link = $item.querySelector(':scope > [data-sg-nav-link]');
...
/***/ "./javascript/components/resizer.js":
/*!******************************************!*\
  !*** ./javascript/components/resizer.js ***!
  \******************************************/
/*! no exports provided */
...
interactjs__WEBPACK_IMPORTED_MODULE_1___default()('[data-sg-resizable]').resizable({
  edges: {
    right: true
  },
  modifiers: [// keep the edges inside the parent
  interactjs__WEBPACK_IMPORTED_MODULE_1___default.a.modifiers.restrictEdges({
    outer: 'parent',
    endOnly: true
  }), // minimum size
  ...
  var parentWidth = event.currentTarget.parentNode.offsetWidth;
...
/***/ "./javascript/components/toggle.js":
/*!*****************************************!*\
  !*** ./javascript/components/toggle.js ***!
  \*****************************************/
/*! no exports provided */
...
/***/ 0:
/*!****************************************************!*\
  !*** multi ./javascript/app.js ./scss/styles.scss ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /Users/phil/Documents/QI/quinn.com/_website/git-quinn/docroot/vendor/benmanu/silverstripe-styleguide/javascript/app.js */"./javascript/app.js");
module.exports = __webpack_require__(/*! /Users/phil/Documents/QI/quinn.com/_website/git-quinn/docroot/vendor/benmanu/silverstripe-styleguide/scss/styles.scss */"./scss/styles.scss");
