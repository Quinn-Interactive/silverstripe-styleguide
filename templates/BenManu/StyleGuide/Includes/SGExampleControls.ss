<div class="sg-example__controls">
    ...
    <% end_if %>
    <button data-clipboard="$Markup.XML" title="Click to copy me." class="sg-example__btn -copy"><img src="$resourceURL('benmanu/silverstripe-styleguide:images/clipboard.svg')" height="16" width="16" alt="Copy Code to Clipboard" /></button>
    <% if $FileSource %>
