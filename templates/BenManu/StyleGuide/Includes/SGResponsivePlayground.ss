<div id="$ReferenceID" class="sg-section">
    ...
    <% if $getTemplate %>
        <% include BenManu/StyleGuide/Includes/SGExampleIframe Markup=$getTemplate, Reference=$ReferenceID %>
    <% end_if %>

    <% if $MarkupNormal %>
        <% include BenManu/StyleGuide/Includes/SGExampleIframe Markup=$MarkupNormal, Reference=$ReferenceID %>
    <% end_if %>
    ...
    <% if $Modifiers %>
        ...
        <% loop $Modifiers %>
            ...
            <% include BenManu/StyleGuide/Includes/SGExampleIframe Markup=$ExampleHtml, Reference=$Reference %>
        <% end_loop %>
    <% end_if %>
</div>
